...
//_________________________________________________________________________________
 ...
 print '<tr><th>' . $headers[0] . '</th><th> ' . $headers[1] . '</th><th> ' . $headers[2] . '</th><th> ' . $headers[3] . '</th><th> ' . $headers[4] . '</th><th> ' . $headers[5] . '</th><th> ' . $headers[6] . '</th></tr>' . "\n";
...
foreach($records as $oneRecord){
	...
	print '<tr><td>' . $oneRecord[0] . '</td><td> ' . $oneRecord[1] . '</td><td> ' . $oneRecord[2] . '</td><td> ' . $oneRecord[3] . '</td><td> ' . $oneRecord[4] . '</td><td> ' . $oneRecord[5] . '</td><td> ' . $oneRecord[6] . '</td></tr>' . "\n";
}
echo '</table>';   
